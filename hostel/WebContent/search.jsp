    ...
    <div class="dashboard">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="search.jsp" class="menu-item" data-section="search">
        ...
        <div class="main-content">
            ...
            PreparedStatement ps = con.prepareStatement("SELECT  ha.ID, hfd.room_number,ha.student_name, ha.start_year,ha.phone_number,hfd.building_details,ha.father_phone FROM hostel_admissions ha JOIN hostel_fee_details hfd ON ha.ID = hfd.ID where room_number = ?");
            ps.setString(1, room);
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                          ...
                          %>
                            ...
                            <td><a href="viewform.jsp?id=<%=  rs.getInt("ID")%>">Click Here</a></td>
